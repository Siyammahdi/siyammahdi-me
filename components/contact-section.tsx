...
const socialLinks = [
  ...
  {
    name: "LinkedIn",
    handle: "in/siyammahdi1",
    icon: Linkedin,
    href: "https://linkedin.com/in/siyammahdi1",
  ...
  {
    name: "Facebook",
    handle: "/siyammahdi911",
    icon: Facebook,
    href: "https://facebook.com/siyammahdi911",
  ...
  {
    name: "Email",
    handle: "siyammahdi1@gmail.com",
    icon: Mail,
    href: "mailto:siyammahdi1@gmail.com",
